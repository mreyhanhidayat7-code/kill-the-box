/* =========================
   KILL THE BOX - FRONTEND
   =========================
   Vercel static frontend + /api/proxy -> Google Apps Script.
   Jangan taruh URL Apps Script langsung di browser jika memakai proxy Vercel.
*/
...
$("loginForm").addEventListener("submit", async (e) => {
  ...
  $("loginStatus").textContent = "Memeriksa login...";
  try {
